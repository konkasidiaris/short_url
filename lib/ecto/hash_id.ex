defmodule ShortUrl.Ecto.HashId do
  @behaviour Ecto.Type
  @hash_id_length 8
  ...
  @doc "Convers/accepts a value that has been directly placed into the ecto struct after a changeset"
  @spec dump(any) :: Map.t
  ...
  @doc "Validate the fiven value as a string"
